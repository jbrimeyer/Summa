...
func GitInit(repoPath string) error {
	_, err := git.InitRepository(repoPath, false)
	return err
}

func GitCommitAll(repoPath string, u *User) error {
	...
	// TODO: stage all files here, including deletions
	err = idx.AddByPath("index.html")
	if err != nil {
		return err
	}
